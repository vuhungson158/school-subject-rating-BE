...
//                       UserRole role, Set<? extends GrantedAuthority> authorities) {
...
//        this(userEntity.email, passwordEncoder.encode(userEntity.password),
//                userEntity.role, userEntity.role.getGrantedAuthorities());
//    }
//}
